...
class UpdateCategoryElementValueRangeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'difference'=>['required_unless:is_difference_affected,false'],
            ...
            'is_difference_affected'=>['required','boolean'],
        ];
    }
